...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_train_steps", type=int, default=2000000, help="Maximum number of training steps")
    ...
    parser.add_argument("--train_recl_freq", type=int, default=100, help="Train frequency of the RECL network")
